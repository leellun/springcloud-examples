...
import com.newland.springcloud.alibaba.dao.OrderDao;
import com.newland.springcloud.alibaba.domain.Order;
import com.newland.springcloud.alibaba.service.AccountService;
...
public class OrderServiceImpl implements OrderService
{
     ...
     * 简单说：下订单->扣库存->减余额->改状态
     */
    @HmilyTCC(confirmMethod = "createOrder",cancelMethod ="cancelOrder")
